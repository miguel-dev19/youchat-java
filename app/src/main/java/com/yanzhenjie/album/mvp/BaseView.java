...
public abstract class BaseView<Presenter extends BasePresenter> {
    ...
    public void toast(CharSequence message) {
        Utils.ShowToastAnimated(actividad,message.toString(),R.raw.contact_check);
    }

    public void toast(@StringRes int message) {
        String cad = actividad.getResources().getString(message);
        Utils.ShowToastAnimated(actividad,cad,R.raw.contact_check);
    }
