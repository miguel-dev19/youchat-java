...
//  EmojiPopup(@NonNull final Builder builder, @NonNull final EditText editText) {
...
//  }
  ...
  EmojiPopup(@NonNull final Builder builder, @NonNull final EditText editText, boolean esChatActivity) {
    this.context = Utils.asActivity(builder.rootView.getContext());
    this.rootView = builder.rootView.getRootView();
    this.editText = editText;
    this.recentEmoji = builder.recentEmoji;
    ...
    final EmojiView emojiView = new EmojiView(context,
            internalOnEmojiClickListener, internalOnEmojiLongClickListener, builder, esChatActivity);
  ...
  public static final class Builder {
    ...
    @CheckResult public EmojiPopup build(@NonNull final EditText editText, boolean esChatAct) {
      EmojiManager.getInstance().verifyInstalled();
      checkNotNull(editText, "EditText can't be null");

      final EmojiPopup emojiPopup = new EmojiPopup(this, editText, esChatAct);
