package cu.alexgi.youchat.photoView;
...
public class CircleImageViewPV extends PhotoView{
    ...
    public CircleImageViewPV(Context context) {
        super(context);

        init();
    }

    public CircleImageViewPV(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageViewPV(Context context, AttributeSet attrs, int defStyle) {
