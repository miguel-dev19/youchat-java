...
import com.yanzhenjie.album.widget.divider.ColorDrawer;
import com.yanzhenjie.album.widget.divider.Divider;
import com.yanzhenjie.album.widget.divider.Drawer;

/**
 * <p>The implementation of divider adds dividers around the list.</p>
 * Created by YanZhenjie on 2017/8/14.
 */
public class ItemDividerUser extends Divider {
     ...
     */
    public ItemDividerUser(@ColorInt int color) {
        this(color, 4, 4);
    }
     ...
     */
    public ItemDividerUser(@ColorInt int color, int width, int height) {
