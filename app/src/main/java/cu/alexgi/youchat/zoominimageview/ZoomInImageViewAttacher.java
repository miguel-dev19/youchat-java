...
import cu.alexgi.youchat.zoominimageview.animation.AnimCompat;
import cu.alexgi.youchat.zoominimageview.animation.SpringInterpolator;
import cu.alexgi.youchat.zoominimageview.gestures.OnScaleAndMoveGestureListener;
import cu.alexgi.youchat.zoominimageview.gestures.ScaleAndMoveDetector;
import cu.alexgi.youchat.zoominimageview.window.WindowManagerUtil;
...
public class ZoomInImageViewAttacher implements View.OnTouchListener {
    ...
    public ZoomInImageViewAttacher(ImageView imageView, boolean zoomable) {
        attachImageView(imageView);
        mZoomEnabled = zoomable;
    }

    public ZoomInImageViewAttacher(ImageView imageView, boolean zoomable, boolean detach) {
        attachImageView(imageView);
        mZoomEnabled = zoomable;
        if(detach)
            detach();
