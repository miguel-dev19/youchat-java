package cu.alexgi.youchat.storiesprogressview;
...
final class PausableProgressBar extends FrameLayout {
     ...
     * progress
     */
//    private static final int DEFAULT_PROGRESS_DURATION = (YouChatApplication.activar_progreso?
//            ((YouChatApplication.tiempo_progreso) * 1000):0);
//    private static final int DEFAULT_PROGRESS_DURATION = 20000;
...
//    private long duration = DEFAULT_PROGRESS_DURATION;
    private long duration = (YouChatApplication.activar_progreso?
            ((YouChatApplication.tiempo_progreso) * 1000):0);
    ...
    public PausableProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        frontProgressView.getBackground().getCurrent().setColorFilter(new PorterDuffColorFilter(Color.parseColor(YouChatApplication.itemTemas.getColor_btn()), PorterDuff.Mode.SRC_IN));
        maxProgressView.getBackground().getCurrent().setColorFilter(new PorterDuffColorFilter(Color.parseColor(YouChatApplication.itemTemas.getColor_btn()), PorterDuff.Mode.SRC_IN));
    }
