...
//    view_icon_answer,
    ...
    public SwipeController(ChatsActivity ca){
        chatsActivity=ca;
...
//            dX_Global=dX;
//            View layout = view_global.findViewById(R.id.contenido_mensaje);
//            View imgReply = view_global.findViewById(R.id.imgView_replyMsg);
//            float signo = getSignFromDirection(view_global);
//            boolean esCorrectaDirSwipe = sameSign(dX, signo);
//            if (actionState == ACTION_STATE_SWIPE && esCorrectaDirSwipe) {
//                SwipeAnimation.update(layout,imgReply,dX,signo);
//                handleSwipeFeedback(imgReply, Math.abs(dX));
//                setTouchListener(recyclerView, dX);
//            } else if (actionState == ACTION_STATE_IDLE || dX == 0.0f) {
//                SwipeAnimation.update(layout,imgReply, 0.0f, 1.0f);
//            }
//        }
//    }
...
//                    drawButtons();
//                }
//                if(dX_Global>(limScroll*2)) puedeSwipear = false;
...
//        if(false){ //chatsActivity.estaModoSeleccionar() &&
//            if(chatsActivity.elPuedeSwipear(viewHolder.getAbsoluteAdapterPosition())){
//                view_global = viewHolder.itemView;
//                dX_Global=dX;
//                View layout = view_global.findViewById(R.id.contenido_mensaje);
