package cu.alexgi.youchat.colorpicker;
...
public class ColorPreferenceCompat extends Preference implements ColorPickerDialogListener {
  ...
  private void init(AttributeSet attrs) {
    ...
    showDialog = a.getBoolean(R.styleable.ColorPickerPreference_cpv_showDialog, true);
    //noinspection WrongConstant
    dialogType = a.getInt(R.styleable.ColorPickerPreference_cpv_dialogType, ColorPickerDialog.TYPE_PRESETS);
    colorShape = a.getInt(R.styleable.ColorPickerPreference_cpv_colorShape, ColorShape.CIRCLE);
    allowPresets = a.getBoolean(R.styleable.ColorPickerPreference_cpv_allowPresets, true);
    allowCustom = a.getBoolean(R.styleable.ColorPickerPreference_cpv_allowCustom, true);
    showAlphaSlider = a.getBoolean(R.styleable.ColorPickerPreference_cpv_showAlphaSlider, false);
    showColorShades = a.getBoolean(R.styleable.ColorPickerPreference_cpv_showColorShades, true);
    previewSize = a.getInt(R.styleable.ColorPickerPreference_cpv_previewSize, SIZE_NORMAL);
    final int presetsResId = a.getResourceId(R.styleable.ColorPickerPreference_cpv_colorPresets, 0);
    dialogTitle = a.getResourceId(R.styleable.ColorPickerPreference_cpv_dialogTitle, R.string.cpv_default_title);
    if (presetsResId != 0) {
