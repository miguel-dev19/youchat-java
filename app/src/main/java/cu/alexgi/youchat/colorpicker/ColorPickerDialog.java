...
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher {
  ...
  @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    super.setStyle(0, R.style.Theme_MaterialComponents_DayNight_Dialog);
    ...
    rootView.setBackgroundColor(Color.parseColor(YouChatApplication.itemTemas.getColor_fondo()));
  ...
  @Override public void onStart() {
    ...
    neutralButton.setTextColor(MainActivity.context.getResources().getColor(R.color.colorAccent));


    dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(MainActivity.context.getResources().getColor(R.color.colorAccent));
    dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(MainActivity.context.getResources().getColor(R.color.colorAccent));
        ...
        @Override public void onClick(View v) {
          ...
          switch (dialogType) {
            case TYPE_CUSTOM:
              ...
              ((Button) v).setTextColor(MainActivity.context.getResources().getColor(R.color.colorAccent));
  ...
  View createPickerView() {
    ...
    contentView.setBackgroundColor(Color.parseColor(YouChatApplication.itemTemas.getColor_fondo()));
