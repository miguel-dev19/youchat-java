...
import cu.alexgi.youchat.adapters.AdaptadorDatosBloqueado;
...
public class BloqueadosActivity extends BaseSwipeBackFragment {

    //Para llenar el recycler
    private ArrayList<ItemContacto> datos_bloqueados;
    private RecyclerView lista_bloqueados;
    private AdaptadorDatosBloqueado adaptadorBloqueados;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return attachToSwipeBack(inflater.inflate(R.layout.activity_bloqueados, container, false));
    }
...
//                Navigation.findNavController(v).navigateUp();
        ...
        datos_bloqueados = dbWorker.obtenerContactosBloqueados();
        adaptadorBloqueados = new AdaptadorDatosBloqueado(datos_bloqueados, this);
    ...
    private synchronized void buscarYborrarA(String correo){
        ...
        for(int i=0; i<l; i++){
            if(datos_bloqueados.get(i).getCorreo().equals(correo)){
