...
public class AdaptadorDatosAlbum extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdaptadorDatosAlbum(Context context, OnItemClickListener itemClickListener) {
