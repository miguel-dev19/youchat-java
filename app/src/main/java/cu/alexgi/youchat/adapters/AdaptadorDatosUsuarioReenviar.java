...
public class AdaptadorDatosUsuarioReenviar extends RecyclerView.Adapter<AdaptadorDatosUsuarioReenviar.ViewHolderDatos> implements View.OnClickListener, View.OnLongClickListener {

    ArrayList<ItemUsuario> listaDatos;
    private View.OnClickListener listener;
    private View.OnLongClickListener onLongClickListener;
    Context context;
    private ColorStateList stateList,stateListEstadoView;

    public AdaptadorDatosUsuarioReenviar(Context c, ArrayList<ItemUsuario> listaDatos) {
        context = c;
    ...
    public void onBindViewHolder(@NonNull ViewHolderDatos holder, int position) {
        ...
        holder.AsignarDatos(usuario.getCorreo(),
                usuario.EsAnclado(), usuario.getCant_mensajes(),
                usuario.getUlt_msg_tipo(), usuario.getUlt_msg_texto(),
                usuario.getUlt_msg_estado(), usuario.getUlt_msg_orden(),
                usuario.isEstaSeleccionado());
    }
    ...
    public class ViewHolderDatos extends RecyclerView.ViewHolder {
        ...
        View ll_usuario_seleccionar;

        EmojiTextView usuarios_lu, ult_mensaje;
        TextView cantMsg, usuarios_time;
        AppCompatImageView estado_view;
        ImageView anclado_view,estado_type,user_verificado;
        View viewBackground;
        CircleImageView preview_chat_image, item_seleccionado, item_en_linea;
        private View user_silenciado;
        //ImageView fotos;
        ...
        public synchronized void AsignarDatos(String cor,
                                              boolean esAncla,
                                              int cant,
                                              int tipo, String text, int estado, String orden,
            ...
            if(estaSelecionado){
                ...
                ll_usuario_seleccionar.setBackgroundResource(R.color.item_seleccionado);
            }
            else {
                item_seleccionado.setVisibility(View.GONE);
                ll_usuario_seleccionar.setBackgroundResource(R.color.fondo_blanco);
            }
            if(esAncla) anclado_view.setVisibility(View.VISIBLE);
        ...
        public void seleccionar(boolean esSeleccionado){
            if(esSeleccionado){
        ...
        private synchronized void cargarImg(ItemContacto contacto) {
            if(contacto.getCorreo().equals(YouChatApplication.idOficial)){
                ...
                if(cache.equals("")) preview_chat_image.setImageResource(R.drawable.profile_white);
                else Glide.with(context).load(cache).into(preview_chat_image);
            }
        }
    }
}
