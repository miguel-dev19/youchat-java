...
import cu.alexgi.youchat.SeguidosFragment;
...
public class AdaptadorDatosSeguido extends RecyclerView.Adapter<AdaptadorDatosSeguido.ViewHolderDatos>
    ...
    SeguidosFragment seguidosFragment;
    private View.OnClickListener listener;
    private View.OnLongClickListener longClickListener;

    public AdaptadorDatosSeguido(ArrayList<ItemContacto> listaDatos, SeguidosFragment s) {
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(YouChatApplication.estaAndandoChatService()
                    ...
                    seguidosFragment.actualizarBadge();
                }
                else Utils.mostrarToastDeConexion(mainActivity);
            }
        });
