...
public class AdaptadorColorFondoEstado extends RecyclerView.Adapter<AdaptadorColorFondoEstado.ViewHolder> {
    ...
    AdaptadorColorFondoEstado(@NonNull Context context, @NonNull List<Integer> colorPickerColors) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.colorPickerColors = colorPickerColors;
    }

    AdaptadorColorFondoEstado(@NonNull Context context) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onColorPickerClickListener != null)
                        onColorPickerClickListener.onColorPickerClickListener(colorPickerColors.get(getAbsoluteAdapterPosition()), getAbsoluteAdapterPosition());
                }
            });
        }
    }
