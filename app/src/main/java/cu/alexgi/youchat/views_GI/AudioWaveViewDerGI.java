...
public class AudioWaveViewDerGI extends AudioWaveView {

    public AudioWaveViewDerGI(Context context) {
        super(context);
        super.setWaveColor(Color.parseColor(YouChatApplication.itemTemas.getColor_msg_der_audio()));
    ...
    public AudioWaveViewDerGI(Context context, AttributeSet attrs) {
        super(context, attrs);
        super.setWaveColor(Color.parseColor(YouChatApplication.itemTemas.getColor_msg_der_audio()));
        super.setChunkSpacing(Utils.dpToPx(MainActivity.context, 1));
        super.setChunkWidth(Utils.dpToPx(MainActivity.context, 2));
    ...
    public AudioWaveViewDerGI(Context context, AttributeSet attrs, int defStyleAttr) {
