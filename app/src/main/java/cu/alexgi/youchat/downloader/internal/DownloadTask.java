...
package cu.alexgi.youchat.downloader.internal;
...
import cu.alexgi.youchat.downloader.Constants;
import cu.alexgi.youchat.downloader.Error;
import cu.alexgi.youchat.downloader.Progress;
import cu.alexgi.youchat.downloader.Response;
import cu.alexgi.youchat.downloader.Status;
import cu.alexgi.youchat.downloader.database.DownloadModel;
import cu.alexgi.youchat.downloader.handler.ProgressHandler;
import cu.alexgi.youchat.downloader.httpclient.HttpClient;
import cu.alexgi.youchat.downloader.internal.stream.FileDownloadOutputStream;
import cu.alexgi.youchat.downloader.internal.stream.FileDownloadRandomAccessFile;
import cu.alexgi.youchat.downloader.request.DownloadRequest;
import cu.alexgi.youchat.downloader.utils.Utils;
...
public class DownloadTask {
    ...
    private void deleteTempFile() {
        cu.alexgi.youchat.Utils.borrarFile(new File(tempPath));
    }
